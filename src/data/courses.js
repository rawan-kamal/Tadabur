...
export const PLAYLIST_COURSES = [
  {
    ...
    description: "نبذة مختصرة وعامة عن كل جزء من اجزاء القرآن الكريم مع الشيخ عمرو الشرقاوي",
  ...
  },
  {
    ...
    description: "وقفات تدبرية مع سور القران الكريم",
    playlistId: "PLnpYU8_AiEPct7B-VmBrWJWifYEcb2TtC",
    titleCleanup: ["مجالس القرآن", "د. أحمد عبد المنعم", "|"],
  },
    {
    id: "playlist-2",
  ...
  {
    id: "playlist-7",
    title: "مجالس القرآن - تدبر سورة  القصص",
    instructor: "باسل مؤنس - رحمه الله",
    description: "وقفات تدبرية مع سورة القصص",
    playlistId: "PLnpYU8_AiEPf_Raw3VWCLu2NwIgivmnLf",
    titleCleanup: ["مجالس القرآن", "باسل مؤنس - رحمه الله", "|"],
  },
  {
    id: "playlist-8",
    title: "تفسير جزء (قد سمع)",
    instructor: "د. أحمد عبد المنعم",
    description: "تفسير سور جزء (قد سمع) مع الدكتور أحمد عبد المنعم",
    playlistId: "PLnpYU8_AiEPcrPemW7RJ-6f-GLp1SAyFV",
    titleCleanup: ["تفسير جزء", "د. أحمد عبد المنعم", "|"],
  },
]